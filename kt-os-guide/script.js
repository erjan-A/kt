...
const railData = {
  ...
  automations: {
    ...
    example: "Пример:\nTelegram reminder -> короткий ответ аналитика -> обновление проектного контекста\nYouTube digest -> краткое summary -> отправка в Telegram",
  ...
  youtube: {
    ...
    body: "Видео из моего YouTube playlist To Summarize становятся не просто summary, а идеями, привязанными к KT, моим проектам и следующему действию.",
    ...
    copy: "Обработай YouTube-видео VIDEO_URL в стиле моей рабочей OS. Сначала получи или прочитай содержание видео доступным способом. Затем сделай digest на русском в формате: Суть, Тезисы, Возможности для моих проектов, Как применить сегодня, Что сохранить в базу знаний. Перед выводом учитывай мои проектные контексты, если они доступны. Если содержание видео недоступно, прямо напиши это и не пересказывай видео по названию.",
  },
  choose: {
  ...
  copy: {
    ...
    example: "Starter kit:\n00_Система/\n01_Проекты/\n02_Источники/\n03_База знаний/\n04_Шаблоны/\n05_Скиллы/\n06_Автоматизация/",
    copy: "Создай starter kit личной AI OS для моей работы. Сначала спроси название моей роли и 1-2 главных типа проектов. Потом предложи структуру папок: 00_Система, 01_Проекты, 02_Источники, 03_База знаний, 04_Шаблоны, 05_Скиллы, 06_Автоматизация. Для каждой папки дай короткий README-текст и первый практический шаг. Перед созданием файлов покажи план.",
  },
};
